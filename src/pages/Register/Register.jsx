                ...
                <div className="m-auto w-96">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-lg px-8 py-10 mb-4">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Link className="inline-block align-baseline font-bold text-sm text-indigo-700  hover:text-green-800" href="#">
                                Forgot Password?
                            </Link>
                        </div>
                    ...
                    <p className="text-center text-lg">
                        ...
                        <Link to='/signIn' className="font-bold hover:underline text-indigo-700 " href="#">
                            Sign in
                        </Link>
                    </p>
                </div>
