...
const Facts = () => {
  return (
    <section className='section-sm lg:-mb-16 lg:section-lg'>
      <div className=' flex flex-col lg:flex-row lg:gap-x-[30px]'>
        ...
        <div className='flex-1 -order-1 lg:order-none'>
          <div className='flex flex-col justify-center h-full lg:pl-[100px]'>
            ...
            data-aos='fade-down' data-aos-delay='500'>Relax And Enjoy a Personalized Day Yoga With Us.</h2>
            <div>
              <div className='mb-2'
              data-aos='fade-down' data-aos-delay='600'>
                <img src={Image} alt="" />
              </div>
              <div className='text-lg font-bold text-heading mb-6'
