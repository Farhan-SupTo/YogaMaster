...
const Cards = () => {
  return (
    <section className="bg-cardsBg lg:-mb-16 min-h-[260px] pb-[55px] lg:-mt-24"
    data-aos='fade-down' data-aos-delay='800' data-aos-duration='1600'>
      <div className=" flex  flex-col lg:flex-row gap-x-[32px] lg:mr-4 lg:ml-4">
        {/* Card group */}
        ...
        {/* card-3 */}
        <div className="bg-white w-full max-w-[542px] mx-auto p-[14px] lg:p-[26px] mt-4 lg:-mt-[77px] z-10 flex-1 shadow-2xl rounded-md flex justify-between items-start"
        data-aos='fade-up' data-aos-delay='800'>
          ...
          <div className="max-w-[240px]">
            ...
            <p className="mb-4 lg:mb-3">
              We're booting online yoga by enabling anyone in the world to learn
              from the best
            </p>
            <a
