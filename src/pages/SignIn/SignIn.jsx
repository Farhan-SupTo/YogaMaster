...
const SignIn = () => {
    ...
    const handleGoogleSignIn = () => {
        signInWithPopup(auth, goolgeProvider)
            .then(result => {
                ...
                fetch('https://server-farhan-supto.vercel.app/users', {
                    method: 'POST',
                    headers: {
    ...
    return (
        <div className='flex items-center justify-center'>
            <div className="h-screen items-center lg:flex mt-10">
                <div className="m-auto w-96">

                    <form onSubmit={handleSubmit(onSubmit)} className="bg-white shadow-xl rounded-lg px-8 py-10 mb-4">
                        <div className="mb-4">
                        ...
                        <div className="flex items-center justify-between">
                            <button
                                className="btn btn-outline btn-primary text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                                type="submit"
                            >
                                Sign In
                            </button>
                            ...
                            <a className="inline-block align-baseline font-bold text-sm text-indigo-700 hover:text-green-800" href="#">
                                Forgot Password?
                            </a>

                        </div>

                        <div className='text-indigo-700 text-center mt-2 font-bold'><p>{success}</p></div>
                    </form>
                    <p className="text-center text-lg mb-2">
                        Don't have an account?{' '}
                        <Link to='/register' className="font-bold hover:underline text-indigo-700 " href="#">
                            Create One
                        </Link>
                    </p>
                ...
                <div className="text-center lg:text-left px-10">
                    <p className="text-3xl font-bold">Access  Classes?</p>
